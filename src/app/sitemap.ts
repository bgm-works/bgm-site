...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/services/web-production`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${baseUrl}/koukoku`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.4 },
  ];
}
